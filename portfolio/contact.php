...
// Fetch contacts data
$sql = "SELECT * FROM contacts LIMIT $offset, $records_per_page";
$result = $conn->query($sql);

// Check if there are contacts
if ($result->num_rows > 0) {
    // Output data of each row
    echo '<div class="table-responsive" style="margin-top: 50px;">'; // Adding a margin-top of 20px (adjust the value as needed)
